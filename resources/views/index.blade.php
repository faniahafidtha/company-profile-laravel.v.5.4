...
<html lang="en">
  <head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrinsk-to-fit=no">
...
<div class="card text-center">
  <div class="card-header h3">
    PELAJAR
    <br>
    <span class="display-4">Rp. 3.000.000</span>
  </div>
  <div class="card-body">
...
<div class="container">
    ...
    <h3 class="mt-5 text-center">PORTFOLIO</h3>
<hr>
<div class="bg-light">
<div class="container">
    <div class="row text-center">
      <div class="col-md-4">
       <a href=""></a>
       <img src="/img/web1.png" class="img-thumbnail"> 
      </div>
      <div class="col-md-4">
        <a href=""></a>
       <img src="/img/web2.jpg" class="img-thumbnail"> 
      </div>
      <div class="col-md-4">
        <a href=""></a>
       <img src="/img/web3.png" class="img-thumbnail"> 
      </div>
      </div>
    </div>
  </div>
